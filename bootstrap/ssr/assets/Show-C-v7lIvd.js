      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="space-y-6" data-v-f5732e18${_scopeId}><div class="flex flex-wrap items-center justify-between gap-4" data-v-f5732e18${_scopeId}><div data-v-f5732e18${_scopeId}><p class="text-xs uppercase tracking-wide text-slate-500" data-v-f5732e18${_scopeId}>Young person</p><h1 class="text-2xl font-semibold text-slate-900" data-v-f5732e18${_scopeId}>${ssrInterpolate(props.youth.first_name)} ${ssrInterpolate(props.youth.last_name)}</h1><p class="text-sm text-slate-500" data-v-f5732e18${_scopeId}>Preferred name: ${ssrInterpolate(props.youth.preferred_name || "—")}</p></div><div class="flex flex-wrap gap-3" data-v-f5732e18${_scopeId}><button class="rounded-2xl border border-rose-200 px-4 py-2 text-sm font-semibold text-rose-600" data-v-f5732e18${_scopeId}> Delete </button>`);
            ...
            _push2(`</div></div><section class="grid gap-6 lg:grid-cols-3" data-v-f5732e18${_scopeId}><div class="panel p-6 lg:col-span-2" data-v-f5732e18${_scopeId}><div class="flex items-center justify-between" data-v-f5732e18${_scopeId}><div data-v-f5732e18${_scopeId}><p class="text-sm font-semibold text-slate-900" data-v-f5732e18${_scopeId}>Profile &amp; status</p><p class="text-xs text-slate-500" data-v-f5732e18${_scopeId}>Update status or preferred name</p></div><span class="${ssrRenderClass([props.youth.status === "active" ? "bg-emerald-100 text-emerald-700" : "bg-amber-100 text-amber-700", "rounded-full px-3 py-1 text-xs font-semibold"])}" data-v-f5732e18${_scopeId}>${ssrInterpolate(props.youth.status)}</span></div><form class="mt-6 grid gap-4 md:grid-cols-2" data-v-f5732e18${_scopeId}><div data-v-f5732e18${_scopeId}><label class="form-label" data-v-f5732e18${_scopeId}>First name</label><input${ssrRenderAttr("value", unref(form).first_name)} class="form-input" data-v-f5732e18${_scopeId}></div><div data-v-f5732e18${_scopeId}><label class="form-label" data-v-f5732e18${_scopeId}>Last name</label><input${ssrRenderAttr("value", unref(form).last_name)} class="form-input" data-v-f5732e18${_scopeId}></div><div data-v-f5732e18${_scopeId}><label class="form-label" data-v-f5732e18${_scopeId}>Preferred name</label><input${ssrRenderAttr("value", unref(form).preferred_name)} class="form-input" data-v-f5732e18${_scopeId}></div><div data-v-f5732e18${_scopeId}><label class="form-label" data-v-f5732e18${_scopeId}>Status</label><select class="form-input" data-v-f5732e18${_scopeId}><option value="pending" data-v-f5732e18${ssrIncludeBooleanAttr(Array.isArray(unref(form).status) ? ssrLooseContain(unref(form).status, "pending") : ssrLooseEqual(unref(form).status, "pending")) ? " selected" : ""}${_scopeId}>Pending</option><option value="active" data-v-f5732e18${ssrIncludeBooleanAttr(Array.isArray(unref(form).status) ? ssrLooseContain(unref(form).status, "active") : ssrLooseEqual(unref(form).status, "active")) ? " selected" : ""}${_scopeId}>Active</option><option value="inactive" data-v-f5732e18${ssrIncludeBooleanAttr(Array.isArray(unref(form).status) ? ssrLooseContain(unref(form).status, "inactive") : ssrLooseEqual(unref(form).status, "inactive")) ? " selected" : ""}${_scopeId}>Inactive</option></select></div><label class="flex items-center gap-2 text-sm text-slate-600" data-v-f5732e18${_scopeId}><input${ssrIncludeBooleanAttr(Array.isArray(unref(form).active) ? ssrLooseContain(unref(form).active, null) : unref(form).active) ? " checked" : ""} type="checkbox" class="rounded" data-v-f5732e18${_scopeId}> Active on register </label><label class="flex items-center gap-2 text-sm text-slate-600" data-v-f5732e18${_scopeId}><input${ssrIncludeBooleanAttr(Array.isArray(unref(form).photo_consent) ? ssrLooseContain(unref(form).photo_consent, null) : unref(form).photo_consent) ? " checked" : ""} type="checkbox" class="rounded" data-v-f5732e18${_scopeId}> Photo consent </label><div class="md:col-span-2 flex justify-end gap-3 pt-4" data-v-f5732e18${_scopeId}><button type="submit" class="rounded-2xl bg-indigo-600 px-4 py-2 text-sm font-semibold text-white"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} data-v-f5732e18${_scopeId}> Save changes </button></div></form></div><div class="panel p-6" data-v-f5732e18${_scopeId}><p class="text-sm font-semibold text-slate-900" data-v-f5732e18${_scopeId}>Guardians</p><p class="text-xs text-slate-500" data-v-f5732e18${_scopeId}>Primary contacts</p><div class="mt-4 space-y-3" data-v-f5732e18${_scopeId}><!--[-->`);
            ssrRenderList(__props.youth.guardians, (guardian) => {
              _push2(`<div class="rounded-2xl border border-slate-100 bg-slate-50 p-4" data-v-f5732e18${_scopeId}><p class="text-sm font-semibold text-slate-900" data-v-f5732e18${_scopeId}>${ssrInterpolate(guardian.first_name)} ${ssrInterpolate(guardian.last_name)}</p><p class="text-xs text-slate-500" data-v-f5732e18${_scopeId}>${ssrInterpolate(guardian.relationship)}</p><p class="text-sm text-slate-600" data-v-f5732e18${_scopeId}>${ssrInterpolate(guardian.primary_phone)}</p></div>`);
            });
            _push2(`<!--]-->`);
            if (!__props.youth.guardians.length) {
              _push2(`<p class="text-sm text-slate-500" data-v-f5732e18${_scopeId}>No guardians linked yet.</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></section><section class="grid gap-6 lg:grid-cols-3" data-v-f5732e18${_scopeId}><div class="panel p-6 lg:col-span-2" data-v-f5732e18${_scopeId}><p class="text-sm font-semibold text-slate-900" data-v-f5732e18${_scopeId}>Recent attendance</p><ul class="mt-4 divide-y divide-slate-100" data-v-f5732e18${_scopeId}><!--[-->`);
            ssrRenderList(__props.youth.attendance_records, (record) => {
              _push2(`<li class="flex items-center justify-between py-3 text-sm" data-v-f5732e18${_scopeId}><span class="text-slate-600" data-v-f5732e18${_scopeId}>${ssrInterpolate(new Date(record.session.session_date).toLocaleDateString())}</span><span class="text-sm font-semibold text-slate-900" data-v-f5732e18${_scopeId}>${ssrInterpolate(record.status)}</span></li>`);
            });
            _push2(`<!--]-->`);
            if (!__props.youth.attendance_records?.length) {
              _push2(`<li class="py-4 text-sm text-slate-500" data-v-f5732e18${_scopeId}>No attendance yet.</li>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</ul></div><div class="panel p-6" data-v-f5732e18${_scopeId}><p class="text-sm font-semibold text-slate-900" data-v-f5732e18${_scopeId}>Consents</p><div class="mt-4 space-y-3" data-v-f5732e18${_scopeId}><!--[-->`);
            ssrRenderList(__props.youth.consents, (consent) => {
              _push2(`<div class="rounded-2xl border border-slate-100 p-3 text-sm" data-v-f5732e18${_scopeId}><p class="font-semibold text-slate-900" data-v-f5732e18${_scopeId}>Signed ${ssrInterpolate(new Date(consent.signed_at).toLocaleDateString())}</p><div class="mt-2 flex flex-wrap gap-2 text-xs text-slate-600" data-v-f5732e18${_scopeId}><span class="${ssrRenderClass(consent.general_attendance ? "text-emerald-600" : "text-rose-500")}" data-v-f5732e18${_scopeId}>Weekly</span><span class="${ssrRenderClass(consent.offsite_events ? "text-emerald-600" : "text-rose-500")}" data-v-f5732e18${_scopeId}>Offsite</span><span class="${ssrRenderClass(consent.media_consent ? "text-emerald-600" : "text-rose-500")}" data-v-f5732e18${_scopeId}>Media</span></div></div>`);
            });
            _push2(`<!--]-->`);
            if (!__props.youth.consents.length) {
              _push2(`<p class="text-sm text-slate-500" data-v-f5732e18${_scopeId}>Awaiting guardian consent.</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="mt-6 rounded-2xl border border-slate-100 bg-slate-50 p-4" data-v-f5732e18${_scopeId}><p class="text-xs uppercase tracking-wide text-slate-500" data-v-f5732e18${_scopeId}>Tokens</p><p class="text-3xl font-semibold text-slate-900" data-v-f5732e18${_scopeId}>${ssrInterpolate(__props.youth.token_account?.balance ?? 0)}</p>`);
            _push2(ssrRenderComponent(unref(Link), {
...
const Show = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f5732e18"]]);
export {
  Show as default
};
