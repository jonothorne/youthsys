import { computed, withCtx, unref, createTextVNode, createVNode, toDisplayString, withDirectives, vModelText, openBlock, createBlock, createCommentVNode, Fragment, renderList, useSSRContext } from "vue";
import { ssrRenderComponent, ssrInterpolate, ssrIncludeBooleanAttr, ssrRenderAttr, ssrRenderList, ssrRenderClass } from "vue/server-renderer";
      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div><section class="panel p-0"${_scopeId}><div class="toolbar flex-col gap-3 sm:flex-row"${_scopeId}><div${_scopeId}><p class="text-sm font-semibold text-slate-900"${_scopeId}>Mark attendance</p><p class="text-xs text-slate-500"${_scopeId}>Tap a status to toggle quickly</p></div><button class="rounded-2xl bg-indigo-600 px-4 py-2 text-sm font-semibold text-white"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""}${_scopeId}> Save attendance </button></div><div class="flex flex-col gap-3 border-b border-slate-100 px-6 py-4 sm:flex-row sm:items-center sm:justify-between"${_scopeId}><div${_scopeId}><p class="text-sm font-semibold text-slate-900"${_scopeId}>Additional attendees</p><p class="text-xs text-slate-500"${_scopeId}>Count visitors or guests not on this register</p></div><div class="flex flex-col items-start gap-2 sm:flex-row sm:items-center sm:gap-4"${_scopeId}><div${_scopeId}><input${ssrRenderAttr("value", unref(form).additional_attendees)} type="number" min="0" class="w-32 rounded-2xl border border-slate-200 px-3 py-2 text-sm"${_scopeId}>`);
            if (unref(form).errors.additional_attendees) {
              _push2(`<p class="text-xs text-rose-600"${_scopeId}>${ssrInterpolate(unref(form).errors.additional_attendees)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><p class="text-sm text-slate-600"${_scopeId}> Total present: <span class="font-semibold text-slate-900"${_scopeId}>${ssrInterpolate(totalCount.value)}</span><span class="text-xs text-slate-400"${_scopeId}>(${ssrInterpolate(presentCount.value)} + extras)</span></p></div></div><div class="divide-y divide-slate-100"${_scopeId}><!--[-->`);
            ...
            return [
              ...
              createVNode("div", { class: "space-y-6" }, [
                ...
                createVNode("section", { class: "panel p-0" }, [
                  ...
                  createVNode("div", { class: "flex flex-col gap-3 border-b border-slate-100 px-6 py-4 sm:flex-row sm:items-center sm:justify-between" }, [
                    createVNode("div", null, [
                      createVNode("p", { class: "text-sm font-semibold text-slate-900" }, "Additional attendees"),
                      createVNode("p", { class: "text-xs text-slate-500" }, "Count visitors or guests not on this register")
                    ]),
                    createVNode("div", { class: "flex flex-col items-start gap-2 sm:flex-row sm:items-center sm:gap-4" }, [
                      createVNode("div", null, [
                        withDirectives(createVNode("input", {
                          "onUpdate:modelValue": ($event) => unref(form).additional_attendees = $event,
                          type: "number",
                          min: "0",
                          ...
                          [
                            vModelText,
                            unref(form).additional_attendees,
                            void 0,
                            { number: true }
                          ]
                        ]),
                        unref(form).errors.additional_attendees ? (openBlock(), createBlock("p", {
                          key: 0,
                          class: "text-xs text-rose-600"
                        }, toDisplayString(unref(form).errors.additional_attendees), 1)) : createCommentVNode("", true)
                      ]),
                      createVNode("p", { class: "text-sm text-slate-600" }, [
                        createTextVNode(" Total present: "),
                        createVNode("span", { class: "font-semibold text-slate-900" }, toDisplayString(totalCount.value), 1),
                        createVNode("span", { class: "text-xs text-slate-400" }, "(" + toDisplayString(presentCount.value) + " + extras)", 1)
                      ])
                    ])
                  ]),
