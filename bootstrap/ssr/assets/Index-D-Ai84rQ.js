      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="space-y-6" data-v-1fe63b65${_scopeId}><div class="grid gap-6 lg:grid-cols-3" data-v-1fe63b65${_scopeId}><section class="panel p-6 lg:col-span-2" data-v-1fe63b65${_scopeId}><div class="flex items-center justify-between" data-v-1fe63b65${_scopeId}><div data-v-1fe63b65${_scopeId}><p class="text-sm font-semibold text-slate-900" data-v-1fe63b65${_scopeId}>Registers</p><p class="text-xs text-slate-500" data-v-1fe63b65${_scopeId}>Past and upcoming sessions</p></div><span class="rounded-full bg-slate-100 px-3 py-1 text-xs font-semibold text-slate-600" data-v-1fe63b65${_scopeId}>${ssrInterpolate(__props.sessions.length)} active</span></div><div class="mt-4 overflow-x-auto" data-v-1fe63b65${_scopeId}><table class="min-w-full divide-y divide-border text-sm" data-v-1fe63b65${_scopeId}><thead class="bg-slate-50 text-left text-xs font-semibold uppercase tracking-wide text-slate-500" data-v-1fe63b65${_scopeId}><tr data-v-1fe63b65${_scopeId}><th class="py-2" data-v-1fe63b65${_scopeId}>Date</th><th class="py-2" data-v-1fe63b65${_scopeId}>Type</th><th class="py-2" data-v-1fe63b65${_scopeId}>Present</th><th data-v-1fe63b65${_scopeId}></th></tr></thead><tbody class="divide-y divide-slate-100 bg-white" data-v-1fe63b65${_scopeId}><!--[-->`);
            ssrRenderList(__props.sessions, (session) => {
              _push2(`<tr class="hover:bg-slate-50" data-v-1fe63b65${_scopeId}><td class="py-3" data-v-1fe63b65${_scopeId}><p class="font-semibold text-slate-900" data-v-1fe63b65${_scopeId}>${ssrInterpolate(new Date(session.session_date).toLocaleDateString())}</p><p class="text-xs text-slate-500" data-v-1fe63b65${_scopeId}>${ssrInterpolate(session.name)}</p></td><td class="py-3 text-slate-600" data-v-1fe63b65${_scopeId}>${ssrInterpolate(session.session_type)}</td><td class="py-3" data-v-1fe63b65${_scopeId}>${ssrInterpolate(session.present_total ?? session.present_count ?? 0)}</td><td class="py-3 text-right" data-v-1fe63b65${_scopeId}><div class="flex flex-wrap justify-end gap-3 text-sm font-semibold" data-v-1fe63b65${_scopeId}>`);
              ...
              _push2(`<button class="text-amber-600" data-v-1fe63b65${_scopeId}>Archive</button><button class="text-rose-600" data-v-1fe63b65${_scopeId}>Delete</button></div></td></tr>`);
            });
            _push2(`<!--]-->`);
            if (!__props.sessions.length) {
              _push2(`<tr data-v-1fe63b65${_scopeId}><td colspan="4" class="py-6 text-center text-sm text-slate-500" data-v-1fe63b65${_scopeId}>No sessions yet.</td></tr>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</tbody></table></div></section><section class="panel p-6" data-v-1fe63b65${_scopeId}><p class="text-sm font-semibold text-slate-900" data-v-1fe63b65${_scopeId}>Create session</p><p class="text-xs text-slate-500" data-v-1fe63b65${_scopeId}>Prefill your weekly gatherings</p><form class="mt-4 space-y-4" data-v-1fe63b65${_scopeId}><div data-v-1fe63b65${_scopeId}><label class="form-label" data-v-1fe63b65${_scopeId}>Date</label><input${ssrRenderAttr("value", unref(form).session_date)} type="date" class="form-input" data-v-1fe63b65${_scopeId}>`);
            if (unref(form).errors.session_date) {
              _push2(`<p class="form-error" data-v-1fe63b65${_scopeId}>${ssrInterpolate(unref(form).errors.session_date)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-1fe63b65${_scopeId}><label class="form-label" data-v-1fe63b65${_scopeId}>Name</label><input${ssrRenderAttr("value", unref(form).name)} class="form-input" data-v-1fe63b65${_scopeId}></div><div data-v-1fe63b65${_scopeId}><label class="form-label" data-v-1fe63b65${_scopeId}>Location</label><input${ssrRenderAttr("value", unref(form).location)} class="form-input" data-v-1fe63b65${_scopeId}></div><div data-v-1fe63b65${_scopeId}><label class="form-label" data-v-1fe63b65${_scopeId}>Session type</label><select class="form-input" data-v-1fe63b65${_scopeId}><option value="weekly" data-v-1fe63b65${ssrIncludeBooleanAttr(Array.isArray(unref(form).session_type) ? ssrLooseContain(unref(form).session_type, "weekly") : ssrLooseEqual(unref(form).session_type, "weekly")) ? " selected" : ""}${_scopeId}>Weekly</option><option value="event" data-v-1fe63b65${ssrIncludeBooleanAttr(Array.isArray(unref(form).session_type) ? ssrLooseContain(unref(form).session_type, "event") : ssrLooseEqual(unref(form).session_type, "event")) ? " selected" : ""}${_scopeId}>Event</option></select></div><button type="submit" class="w-full rounded-2xl bg-indigo-600 px-4 py-2 text-sm font-semibold text-white"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} data-v-1fe63b65${_scopeId}> Create &amp; open register </button></form></section></div><section class="panel p-6" data-v-1fe63b65${_scopeId}><div class="flex items-center justify-between" data-v-1fe63b65${_scopeId}><div data-v-1fe63b65${_scopeId}><p class="text-sm font-semibold text-slate-900" data-v-1fe63b65${_scopeId}>Archived sessions</p><p class="text-xs text-slate-500" data-v-1fe63b65${_scopeId}>Stored for reference</p></div></div><div class="mt-4 overflow-x-auto" data-v-1fe63b65${_scopeId}><table class="min-w-full divide-y divide-border text-sm" data-v-1fe63b65${_scopeId}><thead class="bg-slate-50 text-left text-xs font-semibold uppercase tracking-wide text-slate-500" data-v-1fe63b65${_scopeId}><tr data-v-1fe63b65${_scopeId}><th class="py-2" data-v-1fe63b65${_scopeId}>Date</th><th class="py-2" data-v-1fe63b65${_scopeId}>Type</th><th class="py-2" data-v-1fe63b65${_scopeId}>Present</th><th data-v-1fe63b65${_scopeId}></th></tr></thead><tbody class="divide-y divide-slate-100 bg-white" data-v-1fe63b65${_scopeId}><!--[-->`);
            ssrRenderList(__props.archivedSessions, (session) => {
              _push2(`<tr class="hover:bg-slate-50" data-v-1fe63b65${_scopeId}><td class="py-3" data-v-1fe63b65${_scopeId}>${ssrInterpolate(new Date(session.session_date).toLocaleDateString())}</td><td class="py-3 text-slate-600" data-v-1fe63b65${_scopeId}>${ssrInterpolate(session.session_type)}</td><td class="py-3" data-v-1fe63b65${_scopeId}>${ssrInterpolate(session.present_total ?? session.present_count ?? 0)}</td><td class="py-3 text-right" data-v-1fe63b65${_scopeId}><div class="flex flex-wrap justify-end gap-3 text-sm font-semibold" data-v-1fe63b65${_scopeId}>`);
              _push2(ssrRenderComponent(unref(Link), {
                href: _ctx.route("admin.attendance.show", session.id),
                class: "text-indigo-600"
              }, {
              ...
              _push2(`<button class="text-emerald-600" data-v-1fe63b65${_scopeId}>Restore</button><button class="text-rose-600" data-v-1fe63b65${_scopeId}>Delete</button></div></td></tr>`);
            });
            _push2(`<!--]-->`);
            if (!__props.archivedSessions.length) {
              _push2(`<tr data-v-1fe63b65${_scopeId}><td colspan="4" class="py-6 text-center text-sm text-slate-500" data-v-1fe63b65${_scopeId}>No archived sessions.</td></tr>`);
            } else {
              _push2(`<!---->`);
            }
                        ...
                        createVNode("tbody", { class: "divide-y divide-slate-100 bg-white" }, [
                          (openBlock(true), createBlock(Fragment, null, renderList(__props.sessions, (session) => {
                            return openBlock(), createBlock("tr", {
                              ...
                              createVNode("td", { class: "py-3" }, toDisplayString(session.present_total ?? session.present_count ?? 0), 1),
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1fe63b65"]]);
export {
  Index as default
};
