import { ref, watch, mergeProps, useSSRContext, computed, unref, withCtx, createVNode, resolveDynamicComponent, openBlock, createBlock, toDisplayString, createCommentVNode, createTextVNode } from "vue";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Link), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img src="/build/assets/logo.png" alt="Alive Youth" class="w-auto"${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
      ...
      if (showMobileNav.value) {
        ...
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<img src="/build/assets/logo.png" alt="Alive Youth" class="h-10 w-auto"${_scopeId}>`);
            } else {
              return [
                createVNode("img", {
                  src: "/build/assets/logo.png",
