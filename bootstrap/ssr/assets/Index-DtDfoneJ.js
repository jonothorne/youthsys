      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="space-y-6" data-v-018e310c${_scopeId}><section class="panel" data-v-018e310c${_scopeId}><div class="toolbar" data-v-018e310c${_scopeId}><div data-v-018e310c${_scopeId}><p class="text-sm font-semibold text-slate-900" data-v-018e310c${_scopeId}>Directory</p><p class="text-xs text-slate-500" data-v-018e310c${_scopeId}>${ssrInterpolate(__props.youth.total)} records</p></div><div class="flex flex-wrap items-center gap-3" data-v-018e310c${_scopeId}><div class="relative flex items-center rounded-2xl border border-border/80 bg-white px-3 py-2 text-sm text-slate-500 shadow-sm" data-v-018e310c${_scopeId}>`);
            _push2(ssrRenderComponent(Icons.Search, { class: "mr-2 h-4 w-4 text-slate-400" }, null, _parent2, _scopeId));
            _push2(`<input${ssrRenderAttr("value", search.value)} class="w-40 bg-transparent text-sm focus:outline-none" placeholder="Search by name" data-v-018e310c${_scopeId}></div><button class="rounded-2xl bg-slate-900 px-4 py-2 text-sm font-semibold text-white" data-v-018e310c${_scopeId}> Add young person </button></div></div><div class="overflow-x-auto" data-v-018e310c${_scopeId}><table class="min-w-full divide-y divide-border/80 text-sm" data-v-018e310c${_scopeId}><thead class="bg-slate-50 text-left text-xs font-semibold uppercase tracking-wide text-slate-500" data-v-018e310c${_scopeId}><tr data-v-018e310c${_scopeId}><th class="px-4 py-3" data-v-018e310c${_scopeId}>Name</th><th class="px-4 py-3" data-v-018e310c${_scopeId}>Status</th><th class="px-4 py-3" data-v-018e310c${_scopeId}>Tokens</th><th class="px-4 py-3" data-v-018e310c${_scopeId}>Guardians</th><th class="px-4 py-3 text-right" data-v-018e310c${_scopeId}>Actions</th></tr></thead><tbody class="divide-y divide-slate-100 bg-white" data-v-018e310c${_scopeId}><!--[-->`);
            ssrRenderList(__props.youth.data, (person) => {
              _push2(`<tr class="hover:bg-slate-50" data-v-018e310c${_scopeId}><td class="px-4 py-4" data-v-018e310c${_scopeId}><p class="font-semibold text-slate-900" data-v-018e310c${_scopeId}>${ssrInterpolate(person.first_name)} ${ssrInterpolate(person.last_name)}</p>`);
              if (person.preferred_name) {
                _push2(`<p class="text-xs text-slate-500" data-v-018e310c${_scopeId}>Prefers ${ssrInterpolate(person.preferred_name)}</p>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</td><td class="px-4 py-4" data-v-018e310c${_scopeId}><span class="${ssrRenderClass([person.status === "active" ? "bg-emerald-100 text-emerald-700" : person.status === "pending" ? "bg-amber-100 text-amber-700" : "bg-slate-100 text-slate-600", "rounded-full px-3 py-1 text-xs font-semibold"])}" data-v-018e310c${_scopeId}>${ssrInterpolate(person.status)}</span></td><td class="px-4 py-4 font-semibold text-slate-800" data-v-018e310c${_scopeId}>${ssrInterpolate(person.token_account?.balance ?? 0)}</td><td class="px-4 py-4 text-slate-600" data-v-018e310c${_scopeId}><!--[-->`);
              ssrRenderList(person.guardians, (guardian) => {
                _push2(`<p data-v-018e310c${_scopeId}>${ssrInterpolate(guardian.first_name)} ${ssrInterpolate(guardian.last_name)}</p>`);
              });
              _push2(`<!--]--></td><td class="px-4 py-4 text-right" data-v-018e310c${_scopeId}><div class="flex items-center justify-end gap-3" data-v-018e310c${_scopeId}>`);
              ...
              _push2(`<button class="text-sm font-semibold text-rose-500 hover:text-rose-600" data-v-018e310c${_scopeId}> Delete </button></div></td></tr>`);
            });
            _push2(`<!--]--></tbody></table></div><div class="border-t border-border/60 px-4 py-3 text-sm text-slate-500" data-v-018e310c${_scopeId}> Showing ${ssrInterpolate(__props.youth.from)}-${ssrInterpolate(__props.youth.to)} of ${ssrInterpolate(__props.youth.total)} people </div></section></div>`);
            if (showDrawer.value) {
              _push2(`<div class="fixed inset-0 z-40 flex" data-v-018e310c${_scopeId}><div class="w-full flex-1" data-v-018e310c${_scopeId}></div><div class="h-full w-full max-w-md bg-white shadow-2xl" data-v-018e310c${_scopeId}><div class="flex items-center justify-between border-b border-border px-6 py-4" data-v-018e310c${_scopeId}><div data-v-018e310c${_scopeId}><p class="text-lg font-semibold text-slate-900" data-v-018e310c${_scopeId}>Add young person</p><p class="text-xs text-slate-500" data-v-018e310c${_scopeId}>Capture their preferred name and DOB</p></div><button class="rounded-full border border-slate-200 p-2" data-v-018e310c${_scopeId}>`);
              _push2(ssrRenderComponent(Icons.X, { class: "h-4 w-4" }, null, _parent2, _scopeId));
              _push2(`</button></div><form class="space-y-4 px-6 py-6" data-v-018e310c${_scopeId}><div data-v-018e310c${_scopeId}><label class="form-label" data-v-018e310c${_scopeId}>First name</label><input${ssrRenderAttr("value", unref(createForm).first_name)} class="form-input" data-v-018e310c${_scopeId}>`);
              if (unref(createForm).errors.first_name) {
                _push2(`<p class="form-error" data-v-018e310c${_scopeId}>${ssrInterpolate(unref(createForm).errors.first_name)}</p>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div><div data-v-018e310c${_scopeId}><label class="form-label" data-v-018e310c${_scopeId}>Last name</label><input${ssrRenderAttr("value", unref(createForm).last_name)} class="form-input" data-v-018e310c${_scopeId}>`);
              if (unref(createForm).errors.last_name) {
                _push2(`<p class="form-error" data-v-018e310c${_scopeId}>${ssrInterpolate(unref(createForm).errors.last_name)}</p>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div><div data-v-018e310c${_scopeId}><label class="form-label" data-v-018e310c${_scopeId}>Preferred name</label><input${ssrRenderAttr("value", unref(createForm).preferred_name)} class="form-input" data-v-018e310c${_scopeId}></div><div data-v-018e310c${_scopeId}><label class="form-label" data-v-018e310c${_scopeId}>Date of birth</label><input${ssrRenderAttr("value", unref(createForm).date_of_birth)} type="date" class="form-input" data-v-018e310c${_scopeId}></div><div data-v-018e310c${_scopeId}><label class="form-label" data-v-018e310c${_scopeId}>Gender</label><input${ssrRenderAttr("value", unref(createForm).gender)} class="form-input" data-v-018e310c${_scopeId}></div><div class="flex justify-end gap-3 pt-4" data-v-018e310c${_scopeId}><button type="button" class="rounded-2xl border border-slate-200 px-4 py-2 text-sm font-semibold" data-v-018e310c${_scopeId}> Cancel </button><button type="submit" class="rounded-2xl bg-indigo-600 px-4 py-2 text-sm font-semibold text-white"${ssrIncludeBooleanAttr(unref(createForm).processing) ? " disabled" : ""} data-v-018e310c${_scopeId}> Save </button></div></form></div></div>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
                            ...
                            createVNode("td", { class: "px-4 py-4 text-right" }, [
                              createVNode("div", { class: "flex items-center justify-end gap-3" }, [
                                ...
                                createVNode("button", {
                                  ...
                                  onClick: ($event) => remove(person.id)
                                }, " Delete ", 8, ["onClick"])
                              ])
                            ])
                          ]);
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-018e310c"]]);
export {
  Index as default
};
